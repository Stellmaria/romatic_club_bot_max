"""Unified administrator access checks for Telegram handlers.
...
Neither source replaces the other. Environment-defined operators must retain
access even when the database is unavailable, while database-managed admins can
be added and removed without restarting the bot.
"""
...
__all__ = ["configured_admin_ids", "is_admin_user"]
